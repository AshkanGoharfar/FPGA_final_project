...
#
# Generated by export_simulation on Fri May 24 16:11:10 +0430 2019
#
################################################################################
...
switch to the './Ui_ROM.sh' script.
...
./Ui_ROM.sh -noclean_files

For more information on the script, please type './Ui_ROM.sh -help'.
