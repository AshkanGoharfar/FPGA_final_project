...
#
# Generated by export_simulation on Fri May 24 15:59:30 +0430 2019
#
################################################################################
...
switch to the './Wc_ROM.sh' script.
...
./Wc_ROM.sh -noclean_files

For more information on the script, please type './Wc_ROM.sh -help'.
