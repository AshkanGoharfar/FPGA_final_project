...
#
# Generated by export_simulation on Fri May 24 16:05:48 +0430 2019
#
################################################################################
...
switch to the './Wo_ROM.sh' script.
...
./Wo_ROM.sh -noclean_files

For more information on the script, please type './Wo_ROM.sh -help'.
