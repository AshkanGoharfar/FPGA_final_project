...
#
# Generated by export_simulation on Fri May 24 16:04:02 +0430 2019
#
################################################################################
...
switch to the './Wi_ROM.sh' script.
...
./Wi_ROM.sh -noclean_files

For more information on the script, please type './Wi_ROM.sh -help'.
