...
#
# Generated by export_simulation on Tue May 28 18:17:49 +0430 2019
#
################################################################################
...
switch to the './Wf_ROM.sh' script.
...
./Wf_ROM.sh -noclean_files

For more information on the script, please type './Wf_ROM.sh -help'.
