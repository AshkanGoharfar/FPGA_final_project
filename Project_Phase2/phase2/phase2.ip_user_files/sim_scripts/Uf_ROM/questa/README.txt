...
#
# Generated by export_simulation on Fri May 24 16:09:23 +0430 2019
#
################################################################################
...
switch to the './Uf_ROM.sh' script.
...
./Uf_ROM.sh -noclean_files

For more information on the script, please type './Uf_ROM.sh -help'.
