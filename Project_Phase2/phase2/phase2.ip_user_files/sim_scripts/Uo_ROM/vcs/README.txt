...
#
# Generated by export_simulation on Fri May 24 16:13:38 +0430 2019
#
################################################################################
...
switch to the './Uo_ROM.sh' script.
...
./Uo_ROM.sh -noclean_files

For more information on the script, please type './Uo_ROM.sh -help'.
