...
#
# Generated by export_simulation on Fri May 24 16:15:36 +0430 2019
#
################################################################################
...
switch to the './Bc_ROM.sh' script.
...
./Bc_ROM.sh -noclean_files

For more information on the script, please type './Bc_ROM.sh -help'.
